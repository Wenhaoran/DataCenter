...
<div class="easyui-layout" data-options="fit:true,border:false" >
    <div data-options="region:'center',border:false" title="" style="overflow: hidden;padding: 3px;" >
        <form id="fieldAddForm" method="post">
    		<input id="FieldId" name="id" type="hidden" value="${field.id}"/>
            <table class="grid">
            	<tr>
                    <td><font color='red'>*</font>字段 名称</td>
                	<td>
                		<input id="fieldCode" name="code" type="text" placeholder="请输入 字段名称" class="easyui-textbox span2" data-options="required:true" maxlength="32" value="${field.code}"/>
					</td>
                </tr>
                <tr>
                    <td><font color='red'>*</font>字段 描述</td>
                	<td>
                		<input id="fieldCode" name="name" type="text" placeholder="请输入 字段描述" class="easyui-textbox span2" data-options="required:true" maxlength="32" value="${field.name}"/>
					</td>
                </tr>
                <tr>
                ...
                <tr>
                	...
                	<td>
                		<input id="fieldSize" name="size" type="text" placeholder="请输入 字段长度" class="easyui-textbox span2" data-options="required:true" maxlength="32" value="${field.size}"/>
					</td>
                </tr>
                <tr>
                	...
                	<td>
                		...
                		<select id="fieldrefTable" name="refTable" class="easyui-combobox" data-options="width:240,height:26,editable:true,panelHeight:'140px',required:true">
			    			...
			    			<c:forEach items="${tableList}" var="table">
								<option value="${table.tableName}" <c:if test="${table.tableName == field.refTable}">selected="selected"</c:if> >${table.tableName}：${table.comments}</option>
							</c:forEach>
						 </select>
					</td>
                </tr>
                <tr>
                	...
                	<td>
                		...
                		<select id="fieldrefField" name="refField" class="easyui-combobox" data-options="width:240,height:26,editable:true,panelHeight:'140px',valueField:'name',textField:'name'">
                			<option value="${field.refField}">${field.refField}</option>
						 </select>
					</td>
                </tr>
            </table>
