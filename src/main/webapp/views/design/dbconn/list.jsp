...
<script type="text/javascript">
    ...
    //新增页面
    function addFun() {
    	var url="${path}/pages/dbconn/addPage";
    ...
    function editFun(id) {
        ...
        var url="${path}/pages/dbconn/editPage?id=" + id;
		openEditDialog(url,  500, 700, dataGrid, function(cid) {
			modify(cid);
    ...
    function deleteFun(id,index){
    	$.ajax({
    		"dataType" : "json",
    		"type" : "GET",
    		"url" : '${path}/pages/dbconn/delete?id='+id,
    		"cache" : false,
    ...
    function connect(id){
    	$.ajax({
	        type : "post",  
	    	url : "${path}/pages/dbconn/testConnect",  
	    	data:{id:id},
     ...
     <div data-options="region:'north',border:false,title:'查询条件'" style="height:70px; overflow: hidden;background-color: #fff">
	    		<form id="searchForm">
	    			<div class="search_condition">
						...
						<p>
							<b>数据库名称：</b>
	                		<input id="dbname_query" name="dbname" type="text" placeholder="数据库名称" class="easyui-textbox span2" maxlength="50" value=""/>
						</p>
	    				<p class="btnSear">
