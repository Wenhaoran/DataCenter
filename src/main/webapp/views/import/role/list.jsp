...
<script type="text/javascript">
    ...
    function pause(id,index){
    	$.ajax({
    		"dataType" : "json",
    		"type" : "GET",
    		"url" : '${path}/pages/importRole/pause?roleId='+id,
    		"cache" : false,
    ...
    function begin(id,index){
    	$.ajax({
    		"dataType" : "json",
    		"type" : "GET",
    		"url" : '${path}/pages/importRole/setCRON?roleId='+id,
    		"cache" : false,
    		"success" : function(response) {
    			if (response.success) {
   	            	easyui_alert(response.msg);
    ...
    function one(id,index){
    	console.log('${path}/pages/import/index?roleId='+id);
    	$.ajax({
    		"dataType" : "json",
    		"type" : "GET",
    		"url" : '${path}/pages/import/index?roleId='+id,
    		"cache" : false,
    		"success" : function(response) {
    			if (response.success) {
   	            	easyui_alert(response.msg);
